...
I specialize in building scalable backend systems and intelligent applications. My focus is bridging the gap between robust software engineering and data-driven intelligence.

- 🔭 **Currently focusing on:** Advanced Microservices patterns and Real-time Data Processing.
- 🧠 **Deep diving into:** Machine Learning workflows, IoT Protocols (MQTT, CoAP), and DevOps integration.
- ⚙️ **The Goal:** Merging CI/CD pipelines with ML models to deploy "dope stuff" that actually scales.
